...
const ajv = createAjv();
const inputSchema = loadSchema("effective-communication.input.schema.json");
const outputSchema = loadSchema("effective-communication.output.schema.json");
const validateInput = ajv.compile(inputSchema);
const validateOutput = ajv.compile(outputSchema);

export function validateEffectiveCommunicationInput(
  payload: unknown,
): ValidationResult {
...
export function validateEffectiveCommunicationOutput(
  payload: unknown,
): ValidationResult {
