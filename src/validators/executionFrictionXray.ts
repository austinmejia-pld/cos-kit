...
const ajv = createAjv();
const inputSchema = loadSchema("execution-friction-xray.input.schema.json");
const outputSchema = loadSchema("execution-friction-xray.output.schema.json");
const validateInput = ajv.compile(inputSchema);
const validateOutput = ajv.compile(outputSchema);

export function validateExecutionFrictionXrayInput(
  payload: unknown,
): ValidationResult {
...
export function validateExecutionFrictionXrayOutput(
  payload: unknown,
): ValidationResult {
