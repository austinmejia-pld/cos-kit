...
const SKILL_ROOT = resolve(__dirname, "../../skills/interview-analysis/schemas");
...
export function validateInterviewAnalysisInput(payload: unknown): ValidationResult {
...
export function validateInterviewAnalysisOutput(payload: unknown): ValidationResult {
