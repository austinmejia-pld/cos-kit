...
const SKILL_ROOT = resolve(__dirname, "../../skills/meeting-risk-analysis/schemas");
...
export function validateMeetingRiskAnalysisInput(payload: unknown): ValidationResult {
...
export function validateMeetingRiskAnalysisOutput(payload: unknown): ValidationResult {
