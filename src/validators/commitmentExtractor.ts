...
const SCHEMA_ROOT = resolve(__dirname, "../../skills/commitment-extractor/schemas");
...
export function validateCommitmentExtractorInput(
  payload: unknown,
): ValidationResult {
...
export function validateCommitmentExtractorOutput(
  payload: unknown,
): ValidationResult {
