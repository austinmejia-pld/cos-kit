...
const ajv = createAjv();
const inputSchema = loadSchema("decision-quality-audit.input.schema.json");
const outputSchema = loadSchema("decision-quality-audit.output.schema.json");
const validateInput = ajv.compile(inputSchema);
const validateOutput = ajv.compile(outputSchema);

export function validateDecisionQualityAuditInput(
  payload: unknown,
): ValidationResult {
...
export function validateDecisionQualityAuditOutput(
  payload: unknown,
): ValidationResult {
